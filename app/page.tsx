          ...
          <div className="text-center max-w-4xl mx-auto">
            {isAuthenticated ? (
              ...
              <>
                ...
                {/* Come Funziona Section - Per utenti non loggati */}
                <div id="come-funziona" className="mt-16 pt-8">
                  ...
                  <div className="grid md:grid-cols-5 gap-6">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">1. Analizza la Tua Idea</h3>
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">2. Trova il Team Perfetto</h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">3. Presenta agli Investitori</h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">4. Test Startup Readiness</h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">5. Financial Planning</h3>
                      <p className="text-gray-600 text-sm leading-relaxed">
                        Un ecosistema completo per il financial planning dalla validazione dell'idea al funding: <strong>Business Plan Generator, Proiezioni Finanziarie, Valuation Calculator, Funding Scenarios</strong>
                      </p>
                    </div>
                  </div>
                </div>
