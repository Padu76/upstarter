  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Solo tab overview per ora - altri tab commentati per evitare errori di build */}
        {activeTab !== 'overview' && (
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            <div className="text-gray-500 mb-4">
              <BarChart3 className="w-16 h-16 mx-auto mb-4" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Sezione in Sviluppo</h3>
            <p className="text-gray-600 mb-4">
              Il tab "{activeTab}" verrà completato nella prossima versione.
            </p>
            <button
