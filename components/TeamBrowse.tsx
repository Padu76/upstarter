...
export default function TeamBrowse({ onViewProfile, onContactProfile }: {
  onViewProfile?: (profile: TeamProfile) => void
  onContactProfile?: (profile: TeamProfile) => void
}) {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Trova il co-founder perfetto per la tua startup
              </p>
            </div>
                  ...
                  <div key={profile.id} className="bg-white rounded-lg shadow-sm border hover:shadow-lg transition-all duration-200 p-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {onContactProfile && (
                          <button
                            onClick={() => onContactProfile(profile)}
